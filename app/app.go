...
func New(
	...
	*/
	...
	app.BelkycKeeper = *belkycmodulekeeper.NewKeeper(
		appCodec,
		keys[belkycmoduletypes.StoreKey],
		keys[belkycmoduletypes.MemStoreKey],
		app.GetSubspace(belkycmoduletypes.ModuleName),
	)
